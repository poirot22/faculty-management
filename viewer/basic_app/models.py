...
class Faculty(models.Model):
    ...
    permanentAddressSameAsCurrentAddress=models.BooleanField(default=True)
    ...
    year_award=models.CharField(max_length=4,blank=True)
    org_award=models.CharField(max_length=50,blank=True)

    #journals
    journal_name=models.CharField(max_length=100,blank=True)
    journal_vol=models.PositiveIntegerField(default=1)
